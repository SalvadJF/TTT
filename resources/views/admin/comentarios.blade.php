        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach($comentarios as $comentario)
                    ...
                    <td class="px-6 py-4">
                        @if ($comentario->comentable instanceof App\Models\Noticia)
                        <a href="{{ route('noticias.show', $comentario->comentable->id) }}" class="text-blue-600">
                            Noticia: {{ $comentario->comentable->titulo }}
                        </a>
                        @elseif ($comentario->comentable instanceof App\Models\Articulo)
                        <a href="{{ route('articulos.show', $comentario->comentable->id) }}" class="text-blue-600">
                            Artículo: {{ $comentario->comentable->nombre }}
                        </a>
                        @else
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('comentarios.edit', $comentario) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline m-2">Editar</a>
                    </td>
                    <td>
