...
<div class="m-10 mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="font-koulen flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" role="tablist">
        ...
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 text-white" id="settings-styled-tab" type="button" role="tab" aria-controls="actualizaciones" aria-selected="false">Actualizaciones</button>
        </li>
        <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 text-white" id="contacts-styled-tab" type="button" role="tab" aria-controls="reportajes" aria-selected="false">Reportajes</button>
        </li>
        <li role="presentation">
    ...
    @foreach($noticias as $noticia)
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    ...
                    <a href="{{ route('noticias.show', ['noticia' => $noticia]) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Leer más
