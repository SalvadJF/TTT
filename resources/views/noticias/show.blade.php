            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="" class="font-koulen ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $noticia->titulo }}</a>
                </div>
              </li>
            </ol>
        </nav>
...
<div class="flex flex-col md:flex-row w-auto">
    ...
    <div class="w-full md:w-1/4">
        ...
        <div class="flex items-center mb-4">
            <img src="{{ $noticia->usuario->avatarURL }}" alt="Avatar del usuario" class="w-12 h-12 rounded-full mr-2">
