...
export default function EditarEtiquetaModal({ etiqueta, onClose }) {
    ...
    const handleSubmit = (e) => {
        console.log("entro");
        e.preventDefault();
        put(route("etiquetas.update", etiqueta.id), {
            onSuccess: () => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg">
                <p className="text-lg font-semibold mb-4">Editar Etiqueta</p>
