        ...
        <div className="relative group inline-block">
            ...
            <div className="font-medium text-white">
                ...
                <div className="font-koulen flex items-center gap-4 mb-2 mt-2 relative group">
                    <button className="text-decoration-underline bg-violet-900 hover:bg-violet-950 rounded-lg p-2 transform transition-transform duration-300 group-hover:scale-110" onClick={() => setModalOpen(true)}>Monedero {user.monedero}</button>
