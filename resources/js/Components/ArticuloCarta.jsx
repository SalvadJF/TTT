export default function ArticuloCarta ({ articulo }) {
    return (
            <a href={`/articulos/${articulo.id}`} className="max-w-sm bg-cover bg-center bg-no-repeat bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-1" style={{backgroundImage: `url('${articulo.imagen_url}')`}}>
